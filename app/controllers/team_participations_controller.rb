class TeamParticipationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @team_participation.save
        format.html { redirect_to @team_participation, notice: "Team participation was successfully created." }
  ...
  def update
    respond_to do |format|
      if @team_participation.update(team_participation_params)
        format.html { redirect_to @team_participation, notice: "Team participation was successfully updated." }
  ...
  private
    ...
    def team_participation_params
      params.require(:team_participation).permit(:Team, :EventSubEvent, :round, :score, :position)
    end
end
